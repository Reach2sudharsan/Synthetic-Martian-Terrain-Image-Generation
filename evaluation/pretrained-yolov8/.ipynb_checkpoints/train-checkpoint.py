...
if __name__ == "__main__":
    ...
    data_yaml = f"/home/ubuntu/dem-controlnet/Synthetic-Martian-Terrain-Image-Generation/datasets/new_datasets/crater_dataset_{args.synthetic_ratio}synthetic.yaml"
